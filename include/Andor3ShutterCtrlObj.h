...
//###########################################################################
#ifndef ANDOR3SHUTTERCTRLOBJ_H
#define ANDOR3SHUTTERCTRLOBJ_H
...
namespace lima
{
  namespace Andor3
  {
     ...
     * \brief Control object providing Andor3 shutter interface
     *******************************************************************/
    
    class ShutterCtrlObj : public HwShutterCtrlObj
    {
	    DEB_CLASS_NAMESPC(DebModCamera, "ShutterCtrlObj", "Andor3");
