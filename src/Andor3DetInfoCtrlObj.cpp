...
{
#warning Hard-wired answer : Andor NEO, this is currently the only type that is supported by this SDK
  // @TODO Hard-wired answer : Andor NEO, this is currently the only type that is supported by this SDK
  DEB_MEMBER_FUNCT();
  m_cam.getDetectorType(type);
  //  type = std::string("Andor NEO");
}
